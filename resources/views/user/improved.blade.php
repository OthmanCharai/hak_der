...
@section('content')
    ...
    <div class="content">
        ...
        <div class="overflow-x-auto mt-5">
            ...
            <div class="bg-teal-100 mb-3  border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
                <div class="flex">
            ...
            <table class="table">
                    ...
                    <tr class="bg-gray-700 text-white">
                        ...
                        <th class="whitespace-no-wrap">
                            <input type="checkbox" name="selectall" id="selectall" value=""
                                class="input border checkboxall mr-2" id="vertical-checkbox-chris-evans">
                ...
                <tbody>
                    <form method="POST" action="{{ route('approve.all') }}" accept-charset="UTF-8" class="form-horizontal"
                        enctype="multipart/form-data">
                        @csrf
                        @foreach ($users as $user)
                            <tr>
                                <td class="border-b"> <input type="checkbox" name="user_id[]" value="{{ $user->id }}"
                                        class="input border checkboxall mr-2" id="vertical-checkbox-chris-evans"> {{ $user->id }}</td>
                                ...
                                <td class="border-b">
                                    <a href="{{ route('user.approve',$user) }}">
                                        <i data-feather="user-check" class="w-4 h-4 mr-2"
                                ...
                                <td class="border-b">
                                    ...
                                    <a href="{{ route('user.edit',$user) }}">
                                        <i data-feather="edit" class="w-4 h-4 mr-2"
                                            style="display: inline; color: #0d143a"></i>
                                    </a>
            ...
            <div class="row mt-5">
                <button
                    class="button inline-block rightButton bg-blue-600 w-48 mr-1 mb-2 border border-theme-12 text-theme-12">Approve </button>
