                ...
                <div class="intro-y col-span-12 lg:col-span-12">
                    ...
                    <div class="intro-y box">
                        ...
                        <div class="p-5" id="input">
                            ...
                            <div class="preview">
                                <form method="POST" action="{{ route('pay') }}" accept-charset="UTF-8" id="payment-form" class="form-horizontal" enctype="multipart/form-data"><input name="_token" type="hidden" value="hqjWgNQowIBwSTjCMjBkV3SKi4nkpbaR94kUl6NQ">
                                @csrf
                                <input type="hidden" name="invoice_id" value="{{ $invoice[0]->id }}">
                                <div>
                                    <label for="name">Name</label>
                                    <input id="name" name="name" value="Test" placeholder="Jenny Rosen" required=""  class="input w-full border mt-2" placeholder="Input text">
                                </div>
                                <div class="mt-3">
                                    <label for="email">Email </label>
                                    <input id="email" name="email" value="bajaj@gmail.com" type="email" placeholder="jenny.rosen@example.com" required="" class="input w-full border mt-2" placeholder="Input text">
                                </div>
                                <div class="mt-3">
                                    <label for="iban-element">IBAN</label>
                                    <div id="iban-element" class="StripeElement StripeElement--empty input w-full border mt-2"></div>
                                </div>
                                ...
                                <div class="mt-5 pb-5">
                                    <button type="submit" class="button bg-theme-1 text-white">Sepa Direct Debit( Submit Now )</button>
                                </div>
                                <div class="mt-5 pb-5">
                                    <div id="error-message" role="alert" class="text-danger pt-3"></div><br>                                </div>
